...
void Match::showMatch()
{
 ...
 //   cout << left << setw(50) << this->v[0].getNameFootballTeam() << this->v[1].getNameFootballTeam() << endl;
    printCentered(this->v[0].getNameFootballTeam() + tmp1 + this->v[1].getNameFootballTeam());
    //cout << setw(20) << this->time << setw(20) << this->date << endl;
    printCentered(this->time + tmp1 + this->date);
    //cout << "DIEN RA TAI SVD: " << this->address << endl;
    String tmp2("DIEN RA TAI SVD: ");
    printCentered(tmp2 + this->address);
    cout << endl;
}
...
void Match::showschedule()
{
    ...
    String::getline(file, tmp);
    String kt = " ";
    cout << left << setw(15) << "Vong" << setw(20) << "ID Doi thu nhat" << setw(20) << "ID Doi thu hai" << setw(20) << "Thoi gian" << setw(25) << "Ngay thang nam" << setw(20) << "Dia diem" << endl;
    while (!file.eof())
    {
        String tmp;
        String::getline(file, tmp);
        if (String::toint(tmp[0]) != 0)
        {
            ...
            cout << left << setw(15) << idRound + "," << setw(20) << idTeam1 + "," << setw(20) << idTeam2 + "," << setw(20) << time + "," << setw(25) << date + "," << setw(20) << address << endl;
        }
    }
    file.close();
}
